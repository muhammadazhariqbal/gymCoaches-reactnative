                ...
                <View style={styles.main}>
                    <View style={styles.card}>
                        ...
                        <View stryle={styles.details}>
                            <Text style={styles.head}>Riyadh Fitness Gym</Text>
                            <Text style={styles.para}>Down Town civic center Riyadh</Text>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={{ color: '#f3b149', fontWeight: 'bold', fontSize: 20, fontFamily: 'OpenSans', }}> SR 100 </Text>
